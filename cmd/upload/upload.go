...
func NewUploadCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: "  getnote upload ./report.html --token-file ./upload-token.json --max-size-bytes 209715200\n  getnote upload ./report.html --max-size-bytes 209715200 < ./upload-token.json",
